...
class Api::UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_user" do
    assert_difference('Api::User.count') do
      post api_users_url, params: { api_user: { email: @api_user.email, firstname: @api_user.firstname, lastname: @api_user.lastname } }, as: :json
    end
  ...
  test "should update api_user" do
    patch api_user_url(@api_user), params: { api_user: { email: @api_user.email, firstname: @api_user.firstname, lastname: @api_user.lastname } }, as: :json
    assert_response 200
  end
